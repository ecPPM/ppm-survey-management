...
<dialog id="newAttributeModal" {{ $attributes->class(['modal', 'modal-open' => $modalOpen]) }}>
    <div class="modal-box flex flex-col w-11/12 max-w-3xl px-5 md:px-10 pt-0 pb-4 md:pb-8">
        <div class="flex flex-col gap-8 relative">
            ...
            <div class="flex gap-3 items-center justify-end w-full">
                <button wire:click="clearEnumAttributeCreate" class="btn btn-outline">Cancel</button>
                <button wire:click="saveEnumeratorAttribute" class="btn btn-primary">Add Attribute</button>
            </div>
        </div>
    </div>
</dialog>
